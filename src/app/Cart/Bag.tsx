...
const CartPage = () => {
    return (
      <div className=" min-h-screen p-4 md:p-6 pt-14">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 pt-10 ">
          ...
          <div className="md:col-span-2 p-6 rounded-lg">
            ...
            <div className="flex items-center justify-between mb-6 border-b pb-4">
              ...
              <Image src="/Image (6).png" alt="Not sHoWs"  className="w-24 h-24 object-cover"
                 /> 
            ...
            <div className="flex items-center justify-between border-b pb-4">
              <div className="flex items-center gap-4">
              <Image  src="/Image (10).png"  alt="not shown"   className="w-24 h-24 object-cover "
